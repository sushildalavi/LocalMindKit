...
final class FTS5SearchTests: XCTestCase {
  func testMatchQueryReturnsExpectedHitWithSnippetHighlight() async throws {
    ...
    try await db.insertChunks([
      Chunk(
        fileID: fileID, ordinal: 0, text: "Saved the Apple job link from careers page.",
        charStart: 0, charEnd: 44, source: .ocr),
      Chunk(
        fileID: fileID, ordinal: 1, text: "Nothing relevant here.", charStart: 45, charEnd: 67,
        source: .ocr),
    ])
